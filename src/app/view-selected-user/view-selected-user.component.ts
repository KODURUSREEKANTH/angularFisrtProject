...
@Component({
  selector: 'app-view-selected-user',
  templateUrl: './view-selected-user.component.html',
  styleUrls: ['./view-selected-user.component.css']
})
export class ViewSelectedUserComponent implements OnInit {

  constructor(private us: UserServiceService, private route: ActivatedRoute, private router: Router, 
    private transactionService:TransactionService ,private userService:UserServiceService) {
